...
function mostrar_menu() {
  echo ""
  echo "====================================================="
  echo "                 🚀 NMAP PLUS - TAREAS 🚀                  "
  echo "====================================================="
  echo "1. Escanear Puertos (ingresar IP)"
  echo "2. Escanear Equipos en Red (ingresar red CIDR)"
  echo "3. Escanear S.O. por ICMP (ingresar IP)"
  echo "4. Realizar DOS Simulado (ingresar IP)"
  echo "5. Verificar IP de Dominio (ingresar dominio)"
  echo "6. Salir"
  echo ""
}
